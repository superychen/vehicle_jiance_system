...
public class MySqlGenerator {
    public static void Generator(String[] tableName){
        ...
        gc.setOutputDir(projectPath + "/manage-ment/src/main/java")
        ...
        dsc.setDbType(DbType.MARIADB)
                .setUrl("jdbc:mysql://127.0.0.1:3306/security_test")
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/manage-ment/src/main/resources/mapper/" + pc.getModuleName()
...
//===   =========================== 生成配置
    ...
    public static void main(String[] args) {
        Generator(new String[]{"vehicle_step"});
    }
