...
public class MySqlGenerator {
    public static void Generator(String[] tableName){
        ...
        gc.setOutputDir(projectPath + "/login-sms/src/main/java")
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/login-sms/src/main/resources/mapper/" + pc.getModuleName()
...
//===   =========================== 生成配置
    ...
    public static void main(String[] args) {
        Generator(new String[]{"website_count"});
    }
